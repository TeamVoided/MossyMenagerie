...
import org.teamvoided.mossy_menagerie.world.gen.MossyConfiguredFeatures.ARCANE_MOSS_VEGETATION
import org.teamvoided.mossy_menagerie.world.gen.MossyConfiguredFeatures.ASHEN_MOSS_PATCH_BONE_MEAL
import org.teamvoided.mossy_menagerie.world.gen.MossyConfiguredFeatures.ASHEN_MOSS_VEGETATION
import org.teamvoided.mossy_menagerie.world.gen.MossyConfiguredFeatures.AZURE_MOSS_PATCH_BONE_MEAL
import org.teamvoided.mossy_menagerie.world.gen.MossyConfiguredFeatures.AZURE_MOSS_VEGETATION
import org.teamvoided.mossy_menagerie.world.gen.MossyConfiguredFeatures.BONE_MOSS_PATCH_BONE_MEAL
import org.teamvoided.mossy_menagerie.world.gen.MossyConfiguredFeatures.BONE_MOSS_VEGETATION
import org.teamvoided.mossy_menagerie.world.gen.MossyConfiguredFeatures.BRIGHT_MOSS_PATCH_BONE_MEAL
import org.teamvoided.mossy_menagerie.world.gen.MossyConfiguredFeatures.BRIGHT_MOSS_VEGETATION
import org.teamvoided.mossy_menagerie.world.gen.MossyConfiguredFeatures.CHROME_MOSS_PATCH_BONE_MEAL
import org.teamvoided.mossy_menagerie.world.gen.MossyConfiguredFeatures.CHROME_MOSS_VEGETATION
import org.teamvoided.mossy_menagerie.world.gen.MossyConfiguredFeatures.DARK_MOSS_PATCH_BONE_MEAL
import org.teamvoided.mossy_menagerie.world.gen.MossyConfiguredFeatures.DARK_MOSS_VEGETATION
import org.teamvoided.mossy_menagerie.world.gen.MossyConfiguredFeatures.FIRE_MOSS_PATCH_BONE_MEAL
import org.teamvoided.mossy_menagerie.world.gen.MossyConfiguredFeatures.FIRE_MOSS_VEGETATION
...
import org.teamvoided.mossy_menagerie.world.gen.MossyConfiguredFeatures.ROSY_MOSS_VEGETATION
import org.teamvoided.mossy_menagerie.world.gen.MossyConfiguredFeatures.RUSTY_MOSS_PATCH_BONE_MEAL
import org.teamvoided.mossy_menagerie.world.gen.MossyConfiguredFeatures.RUSTY_MOSS_VEGETATION
import org.teamvoided.mossy_menagerie.world.gen.MossyConfiguredFeatures.TWISTED_MOSS_PATCH_BONE_MEAL
import org.teamvoided.mossy_menagerie.world.gen.MossyConfiguredFeatures.TWISTED_MOSS_VEGETATION
import org.teamvoided.mossy_menagerie.world.gen.MossyConfiguredFeatures.WOODED_MOSS_PATCH_BONE_MEAL
import org.teamvoided.mossy_menagerie.world.gen.MossyConfiguredFeatures.WOODED_MOSS_VEGETATION
